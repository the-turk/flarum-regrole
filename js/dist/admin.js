...
/* harmony import */ var _modals_RegRoleSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modals/RegRoleSettingsModal */ "./src/admin/modals/RegRoleSettingsModal.js");


flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('the-turk/regrole', function (app) {
  app.extensionSettings['the-turk-regrole'] = function () {
    return app.modal.show(new _modals_RegRoleSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});

/***/ }),

/***/ "./src/admin/modals/RegRoleSettingsModal.js":
/*!**************************************************!*\
  !*** ./src/admin/modals/RegRoleSettingsModal.js ***!
  \**************************************************/
/*! exports provided: default */
...
var RegRoleSettingsModal = /*#__PURE__*/function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(RegRoleSettingsModal, _SettingsModal);
  ...
  _proto.form = function form() {
    ...
    return [m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'roleIds')), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'roleIdsHelp')), m('div', [flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.all('groups').filter(function (group) {
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'multipleRoles'),
      onchange: function onchange(value) {
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(localePrefix + 'forceUsers'),
      onchange: function onchange(value) {
